...
curl https://downloads.d2iq.com/kommander/airgapped/v2.1.1/kommander_image_bundle_v${var.dkpversion}_linux_amd64.tar --output /tmp/kommander_image_bundle_v2.1.1_linux_amd64.tar
